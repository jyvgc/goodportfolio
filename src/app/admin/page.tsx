    ...
    <div style={{ minHeight:"100vh", background:"#0a0a0f", color:"#f0f0ff" }}>
      ...
      <div style={{ maxWidth:1200, margin:"0 auto", padding:"100px 24px 60px" }}>
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:8, flexWrap:"wrap", gap:12 }}>
          <h1 style={{ fontSize:24, fontWeight:800 }}>관리자 대시보드</h1>
          <span style={{ padding:"4px 14px", borderRadius:999, fontSize:12, fontWeight:600, background:"rgba(239,68,68,0.15)", color:"#f87171", border:"1px solid rgba(239,68,68,0.3)" }}>🔐 관리자 모드</span>
        </div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(3,1fr)", gap:16 }} className="admin-menu">
          {MENU.map((m) => (
            <Link key={m.href} href={m.href}
              style={{ background:"#111118", border:"1px solid #2e2e3f", borderRadius:16, padding:24, textDecoration:"none", display:"flex", alignItems:"center", gap:16, transition:"all 0.3s" }}
