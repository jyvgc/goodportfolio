...
export default function ProfessorWorksPage() {
  ...
  const filtered = works.filter((w) => {
    ...
    return w.title?.toLowerCase().includes(s) || w.authorName?.toLowerCase().includes(s);
  });
  ...
  return (
    <div style={{ minHeight:"100vh", background:"#0a0a0f", color:"#f0f0ff" }}>
      ...
      <div style={{ maxWidth:1100, margin:"0 auto", padding:"100px 24px 60px" }}>
        ...
        <h1 style={{ fontSize:24, fontWeight:900, marginBottom:8, marginTop:16 }}>작품 관리</h1>
